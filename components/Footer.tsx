    ...
    <footer className="py-20 md:py-32 px-6 md:px-12 lg:px-24 bg-charcoal-900 border-t border-charcoal-800 relative">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16 mb-16">
          ...
          >
            <h3 className="text-sm uppercase tracking-wider text-white mb-6">Connect</h3>
            <div className="space-y-4">
              <a
                href="mailto:annmaina.info@gmail.com"
                className="flex items-center gap-3 text-charcoal-300 hover:text-orange-600 transition-colors duration-300"
              >
