...
const allProjects = [
  {
    ...
    href: '/work/bongohub',
    tags: ['Marketplace', 'Community', 'Web App', 'UX Research'],
    category: 'Web3',
    year: '2024',
    duration: '6 months',
  },
  ...
  },
  {
    ...
    tags: ['Fintech', 'Dashboard', 'Web App', 'Financial Planning'],
    category: 'Fintech',
    year: '2024',
    duration: '3 months',
  },
  {
    ...
    tags: ['Crypto', 'Web App', 'Real-time Data', 'Conversion Tool'],
    category: 'Fintech',
    year: '2023',
    duration: '2 months',
  },
  {
    ...
    href: '/work/predix',
    tags: ['Crypto', 'AI', 'Trading', 'Mobile App'],
    category: 'Fintech',
    year: '2023',
    duration: '5 months',
  },
  ...
  },
  {
    ...
    tags: ['Crypto', 'Content', 'News', 'Web App'],
    category: 'Dashboards',
    year: '2023',
    duration: '3 months',
  },
  {
    ...
    tags: ['Fintech', 'Dashboard', 'Personal Finance', 'Web App'],
    category: 'Fintech',
    year: '2023',
    duration: '4 months',
  },
  {
    ...
    href: '/work/meal-prep',
    tags: ['Food Tech', 'Mobile App', 'E-commerce', 'Health'],
    category: 'Mobile',
    year: '2023',
    duration: '3 months',
  },
  {
    ...
    href: '/work/mintify',
    tags: ['Web3', 'NFT', 'Marketplace', 'Blockchain'],
    category: 'Web3',
    year: '2023',
    duration: '5 months',
  },
  {
    ...
    tags: ['Fintech', 'Productivity', 'Mobile App', 'Subscription Management'],
    category: 'Mobile',
    year: '2022',
    duration: '3 months',
  },
...
const filters = ['All', 'Fintech', 'Web3', 'Mobile', 'Dashboards'];
